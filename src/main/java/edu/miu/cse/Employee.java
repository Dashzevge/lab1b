...
public class Employee {
   ...
   private PensionPlan pensionPlan;
    ...
    public boolean isEligibleForPension(LocalDate startDate, LocalDate endDate) {
        LocalDate eligibilityDate = employmentDate.plusYears(5);
        return (eligibilityDate.isEqual(startDate) || eligibilityDate.isEqual(endDate) ||
                (eligibilityDate.isAfter(startDate) && eligibilityDate.isBefore(endDate)));
